  ...
  const fetchCartData = useCallback(async () => {
    ...
    try {
      const response = await fetch(
        `https://crudcrud.com/api/3da8b2b403e54eb2a05f0860a72de390/cart_${formattedEmail}`,
        {
          method: 'GET',
          headers: {
  ...
  const updateCartData = useCallback(async (items) => {
    ...
    try {
      if (cartId) {
        ...
        await fetch(
          `https://crudcrud.com/api/3da8b2b403e54eb2a05f0860a72de390/cart_${formattedEmail}/${cartId}`,
          {
            method: 'PUT',
            headers: {
              'Content-Type': 'application/json',
